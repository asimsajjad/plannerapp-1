$(document).ready(function() {
	var items = [
		...
		{
		  "name": "Ceilingfan",
		  "model": "models/gltf/ceilingFan.glb",
		  "type": "0",
		...
		},
		{
		  ...
		  "meta": {
			...
			"steps": {//key as min-max
			  "1-100": "models/gltf/windows.glb",
			  "101-200": "models/gltf/windows1.glb",
			  "201-10000": "models/gltf/windows2.gltf"
			}
		  }
		},
		{
		...
		{
		  "name": "Fitness4u",
		  "model": "models/gltf/fitness4u.glb",
		  "type": "1",
		  "image": "models/thumbnails_new/fitness4u.png",
		  "format": "gltf"
		},
		{
		  "name": "Chandelier",
		...
		},
		{
			...
			},
		  {
			...
			"type": "8",
			"image": "models/thumbnails/AnimationTriangle.gif",
			"format": "gltf",
			"meta": {
			  "animation": true
			}
